function [im_array, imgData, imgInfo, refData, refInfo] = canon_getImage(filename, filedirectory, refname, refdirectory, frame)
    frame = 1;
...
% %     
    ...
    [imgInfo, refInfo, imgData, refData] = canon_getData(Files, refFiles, analysisParams);
