function [ROI_positions] = compute_roi_windows_py(...   %scConversion,... contains coordinates xmap and ymap for preSC conversion
    ...
    axial_overlap, lateral_overlap, ...
    thresholdPercentage)  % Percent (%) - Overlap - AEK: Currently symmetrical. 
